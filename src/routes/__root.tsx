...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Alien Complaint Portal 👽 — Off-World Grievance Filing" },
      {
        name: "description",
        content:
          "File, track and investigate extraterrestrial complaints about Earth. Because even aliens have problems.",
      },
      { name: "author", content: "Ministry of Off-World Grievances" },
